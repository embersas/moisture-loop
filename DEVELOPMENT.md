...
The executed-evidence checker enforces all 134 normative IDs, I1-I37, T1-T59,
and the documented skip boundary. The authoritative mapping remains in
`tests/traceability_manifest.py`; do not duplicate it in user documentation.
